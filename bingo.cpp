...
*/
	...
	Beep(500+(10*20),SLEEPBINGO*5);
	Beep(500+(11*20),SLEEPBINGO*3);
 
   
	gotoxy(35, 25);
	textcolor(15);
	cout << "Version 3.1						    ISC 2B";
	gotoxy(20, 25);
	system("pause");
